...
/*Mocking to remove all items from learning path landing page*/
/*We have also mocked set so our tests do not effect the local storage*/


describe('test suite: selectedLearningPath', () => {
    it('takes user to selected learningPath', () => {
    ...
    it('replaces already selected learning path', () => {
        spyOn(localStorage, 'setItem');
